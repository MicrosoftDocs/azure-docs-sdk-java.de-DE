...
ms.locfileid: "61592657"
---
# <a name="azure-management-libraries-for-java-samples-for-sql-database"></a><span data-ttu-id="ae577-104">Azure-Verwaltungsbibliotheken für Java-Beispiele für SQL-Datenbank</span><span class="sxs-lookup"><span data-stu-id="ae577-104">Azure management libraries for Java samples for SQL Database</span></span>
